    ...
    <header className={clsx(styles.heroBanner)}>
      <div className="container">
        <div className={styles.heroShell}>
          <div>
            <p className={styles.eyebrow}>JACK Whitepaper v1.0.1</p>
            <Heading as="h1" className={styles.heroTitle}>
              Intent-first execution with policy-enforced settlement
            </Heading>
            <p className={styles.heroSubtitle}>
              JACK turns high-level intents into verifiable execution plans: solver
              competition off-chain, routing via infrastructure like LI.FI, and
              settlement-time guardrails through programmable Uniswap v4 hooks.
            </p>
            <div className={styles.heroButtons}>
              ...
              <Link className="button button--secondary button--lg" to="/docs/demo-script">
                Demo narrative
              </Link>
            </div>
            <div className={styles.stateMachine} aria-label="Execution lifecycle states">
              <span>CREATED</span>
              <span>QUOTED</span>
              <span>EXECUTING</span>
              <span>SETTLED</span>
          ...
          <aside className={styles.heroPanel}>
            ...
            <ul>
              ...
              <li>Best-effort routing with explicit failure states and reason codes.</li>
        ...
        <section className={styles.setupBand}>
          <div className={styles.setupBandHeader}>
            ...
            <p>
              Use the same dev topology as the MVP demo: landing, dashboard, and docs
              running together.
            </p>
          </div>
          <ol className={styles.setupList}>
            ...
            <li>
              <strong>Run contract checks:</strong> <code>pnpm contracts:test</code> before
              demo recording
            </li>
          </ol>
        </section>
